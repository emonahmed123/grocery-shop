    ...
    <section className="py-[50px] md:py-[75px]">
      <div className=" max-w-Container mx-auto px-5 xl:px-0">
        <div className=" text-center mb-5 ">
          ...
          <p className="text-foreground w-full md:w-1/2 mx-auto">
            Discover our top categories, featuring everything from cozy clothing
            to essential baby gear.we haveve curated the best products to keep
            your little one happy and healthy.
          </p>
        </div>
        {/* cards */}
